...
A powerful mock interview tool powered by OpenAI GPT-4o.
...
class InterviewEngine:
    """Core AI engine that drives the mock interview using OpenAI GPT-4o."""
    ...
    def generate_question(
        ...
        raw = self._call_gpt(system, user)
    ...
    def generate_study_plan(self, session: InterviewSession) -> str:
        ...
        return self._call_gpt(system, user)
...
║          Built with Python · Powered by GPT-4o               ║
╚═══════════════════════════════════════════════════════════════╝
    """
